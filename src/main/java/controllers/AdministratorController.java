...
public class AdministratorController extends AbstractController {
	...
	public ModelAndView list() {
		...
		Collection<Actor> findActorWithMoreMessagesSent = new ArrayList<Actor>();
		Collection<Actor> findActorWithMoreMessagesReceived = new ArrayList<Actor>();
		...
		if (actorService.findAll().isEmpty()) {
			findActorWithMoreMessagesSent = new ArrayList<Actor>();
		} else {
			findActorWithMoreMessagesSent = actorService.findActorWithMoreMessagesSent();
		}
		if (actorService.findAll().isEmpty()) {
			findActorWithMoreMessagesReceived = new ArrayList<Actor>();
		} else {
			findActorWithMoreMessagesReceived = actorService.findActorWithMoreMessagesReceived();
		}
		...
		result.addObject("findActorWithMoreMessagesSent", findActorWithMoreMessagesSent);
		result.addObject("findActorWithMoreMessagesReceived", findActorWithMoreMessagesReceived);
